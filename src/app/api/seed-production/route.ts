...
const products = [
    ...
    `,
        ...
        productBrief: "The summertime treat from your fave ice cream truck just got an upgrade. Creamy, vanilla goodness and a bright pop of tangerine and mandarin citrus join forces to bring back this iconic childhood flavor.",
        nutritionFacts: [
    ...
    `,
        ...
        productBrief: "A sophisticated blend that combines the warming spice of ginger with the bright acidity of lime for a perfectly balanced cocktail experience that's both refreshing and warming.",
        nutritionFacts: [
    ...
    `,
        ...
        productBrief: "The Maca Martini combines the rich, earthy flavors of maca root with decadent coffee and chocolate notes for a sophisticated blend that offers both indulgence and wellness.",
        nutritionFacts: [
    ...
    `,
        ...
        productBrief: "Transport yourself to a tropical paradise with our Tropical Twist blend. The sweet, juicy flavor of pineapple perfectly complements the creamy richness of coconut.",
        nutritionFacts: [
    ...
    `,
        ...
        productBrief: "Our Berry Bliss blend combines the antioxidant power of mixed berries with the refreshing coolness of mint for a vibrant cocktail mix perfect for health-conscious cocktail lovers.",
        nutritionFacts: [
    ...
    `,
        ...
        productBrief: "Wake up your taste buds with our Citrus Splash blend. The perfect combination of tart lemon and zesty lime creates an energizing cocktail experience that's both refreshing and invigorating.",
        nutritionFacts: [
